...
set_property PACKAGE_PIN U9 [get_ports in0[0]]					
set_property IOSTANDARD LVCMOS33 [get_ports in0[0]]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports in0[1]]					
set_property IOSTANDARD LVCMOS33 [get_ports in0[1]]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports in0[2]]					
set_property IOSTANDARD LVCMOS33 [get_ports in0[2]]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports in0[3]]					
set_property IOSTANDARD LVCMOS33 [get_ports in0[3]]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports in1[0]]					
set_property IOSTANDARD LVCMOS33 [get_ports in1[0]]
###Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports in1[1]]					
set_property IOSTANDARD LVCMOS33 [get_ports in1[1]]
###Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = SW6
set_property PACKAGE_PIN V6 [get_ports in1[2]]					
set_property IOSTANDARD LVCMOS33 [get_ports in1[2]]
###Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
set_property PACKAGE_PIN V5 [get_ports in1[3]]					
set_property IOSTANDARD LVCMOS33 [get_ports in1[3]]
###Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
#set_property PACKAGE_PIN U4 [get_ports in2[5]]					
#set_property IOSTANDARD LVCMOS33 [get_ports dm_addr[5]]
####Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
#set_property PACKAGE_PIN V2 [get_ports dm_addr[6]]					
#set_property IOSTANDARD LVCMOS33 [get_ports dm_addr[6]]
####Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
#set_property PACKAGE_PIN U2 [get_ports dm_addr[7]]					
#set_property IOSTANDARD LVCMOS33 [get_ports dm_addr[7]]
...
#set_property PACKAGE_PIN T8 [get_ports {clk_out}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {clk_out}]
###Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports {clken_out}]					
#set_property IOSTANDARD LVCMOS33 [get_ports {clken_out}]
...
set_property PACKAGE_PIN L3 [get_ports {digitsout[0]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {digitsout[0]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {digitsout[1]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {digitsout[1]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {digitsout[2]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {digitsout[2]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {digitsout[3]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {digitsout[3]}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {digitsout[4]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {digitsout[4]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {digitsout[5]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {digitsout[5]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {digitsout[6]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {digitsout[6]}]
##Bank = 34, Pin name = IO_L16P_T2_34,						Sch name = DP
set_property PACKAGE_PIN M4 [get_ports {digitsout[7]}]							
set_property IOSTANDARD LVCMOS33 [get_ports {digitsout[7]}]
